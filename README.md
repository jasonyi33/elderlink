...
- **Speech-to-Text:** ElevenLabs Scribe v1 (industry-leading accuracy, 30+ languages)
...
- **Speech Recognition:** ElevenLabs Scribe v1 (industry-leading accuracy, 30+ languages)
